namespace :import do
    ...
    task xlsx: :environment do
        ...
        xlsx.sheet("Hoja1").each(id: 'ID (RUT)', email_particular: 'EMAIL_PARTICULAR', email_comercial: 'EMAIL_COMERCIAL', email_unab: 'EMAIL_UNAB', name: 'NAME', program: 'PROGRAM', program_desc: 'PROGRAM_DESC', campus_desc: 'CAMPUS_DESC', facultad_oai: 'FACULTAD_OAI', nivel_oai: 'NIVEL_OAI', jornada: 'JORNADA', nivel: 'NIVEL', modalidad: 'MODALIDAD', student_level_desc: 'STUDENT_LEVEL_DESC') do |hash|
